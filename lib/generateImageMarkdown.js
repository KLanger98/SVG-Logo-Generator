...
class Logo{
    ...
    generateMarkdown(){
        ...
        <text x="${this.shapeObject.textPositionX}" y="${this.shapeObject.textPositionY}" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
